...
# one_day_backend/
APPS_DIR = ROOT_DIR / "one_day_backend"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "one_day_backend.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "one_day_backend.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Taejung Heo""", "gjdigj145@gmail.com")]
